...
function Student(inputGrade, inputBan, inputNumber, inputName) {
  ...
  this.information = function () {
    let str = `${this.grade}학년 ${this.class}반 ${this.number}번 ${this.name}`;
    return str; // 호출한 곳으로 문자열을 반환
  }
}
//-----------------------------------------------------------------------
...
addStudent.addEventListener("click", () => {
  ...
  const std = new Student(inputGrade.value, inputBan.value,
    inputNumber.value, inputName.value, inputGender.value);
